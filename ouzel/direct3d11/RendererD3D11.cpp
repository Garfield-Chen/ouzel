...
namespace ouzel
{
    namespace graphics
    {
        ...
        BlendState* RendererD3D11::createBlendState(bool enableBlending,
        ...
        bool RendererD3D11::activateBlendState(BlendState* blendState)
        {
        ...
        Shader* RendererD3D11::loadShaderFromFiles(const std::string& pixelShader,
        ...
        Shader* RendererD3D11::loadShaderFromBuffers(const uint8_t* pixelShader,
        ...
        bool RendererD3D11::drawMeshBuffer(MeshBuffer* meshBuffer, uint32_t indexCount, DrawMode drawMode, uint32_t startIndex)
        {
